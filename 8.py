...
class Playlist:
    ...
    def next_node(self):
        if self.current_node is None:
            ...
            label=tk.Label(newWindow,text='CURRENTLY PLAYING',bg='SlateBlue1',fg='white',justify='center')
            label1=tk.Label(newWindow,text=self.current_node.data,bg='SlateBlue1',fg='white',justify='center')

            label.place()
            label1.place()
            label.grid(row=10, column=50, padx=5, pady=5)
            label1.grid(row=15, column=15, padx=5, pady=5)
...
def main():
    ...
    specific_button = tk.Button(root, text="Play Specific",fg='white',bg='SlateBlue1', command=lambda: play_specific(playlist, entry))
    ...
    #image = Image.open('C:\\Users\\sammy\\Downloads\\Cromartie High School.jpg')
    #image = ImageTk.PhotoImage(file='C:\\Users\\sammy\\Downloads\\Cromartie High School.jpg')
    #image_label = tk.Label(root, image=image)
    #image_label.grid(row=0,column=0,columnspan=10,padx=5,pady=5)
